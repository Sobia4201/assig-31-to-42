...
document.write("laterDate:" +laterDate ,"<br>", "<br>")
...
document.write("seconds elapsed between the refrence date and the beginning of 2015:" +timeDifference ,"<br>", "<br>");
...
document.write("your age is:" +birthYear ,"<br>", "<br>")
...
document.write("<br>")
    ...
    document.write("Gross Amount Payable (after Due Date): " + grossAmountPayable ,"<br>", "<br>");
}
...
document.write("value 01: " + number1 + " value 02: " + number2 + " RESULT: " + val ,"<br>", "<br>")
...
document.write(factorial(10) ,"<br>", "<br>")
...
document.write(ispalindrome("fox") ,"<br>", "<br>")
...
document.write(ispalindrome("yoyo") ,"<br>", "<br>")
...
document.write(uppercase("the quick brown fox") ,"<br>", "<br>");
...
return newString[0];
} document.write(long("keyword are") ,"<br>", "<br>");
...
document.write(occurrences ,"<br>", "<br>")
...
const resulty = deleteVowels(sentence);
console.log(resulty)
...
function convertToMeters(distanceKm) {
  ...
  document.write("Distance in centimeters:", distanceCm ,"<br>", "<br>");
